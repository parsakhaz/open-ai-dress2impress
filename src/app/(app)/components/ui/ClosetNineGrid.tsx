  ...
  return (
    <GlassPanel className="h-full">
      ...
      <div className="relative h-[60vh] md:h-[70vh] flex items-center justify-center">
        ...
        >
          {slots.map((item, idx) => (
            <div key={idx} className="relative rounded-xl border border-dashed border-border bg-background overflow-hidden">
              <div
              ...
              >
                {item ? (
                  <>
                    ...
                    />
                    {/* No hover Try On overlay in StylingRound; click applies directly */}
                  </>
                ) : (
