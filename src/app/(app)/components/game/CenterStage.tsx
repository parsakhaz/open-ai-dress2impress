    ...
    <div className="absolute inset-0 w-full h-full flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 z-0">
      {currentImageUrl ? (
        ...
        <div className="text-center space-y-4 z-10">
          <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-accent/20 to-accent/10 flex items-center justify-center">
          ...
          <div className="space-y-2">
            <h3 className="text-2xl font-medium text-slate-900 dark:text-slate-100">Center Stage</h3>
            <p className="text-slate-600 dark:text-slate-400">Your styled look will appear here</p>
          </div>
        </div>
      )}
    </div>
